...
function custom_theme_scripts() {
	...
	// wp_enqueue_script( 'custom-theme-vendor-scripts', get_template_directory_uri() . '/assets/js/vendor.min.js', array(), '20151215', true );
	// custom custom_theme_scripts
	// note that we pass 'customize-preview' into the array();
	wp_enqueue_script( 'custom-theme-custom-scripts', get_template_directory_uri() . '/assets/js/custom.min.js', array('customize-preview'), '20151215', true );
...
function groupButtonFillVars($vars){
	$vars[] = 'group';
	return $vars;
}
// hook add_rewrite_rules function into rewrite_rules_array
add_filter('query_vars', 'groupButtonFillVars');
