...
function trigger() {
  document.getElementById('li menu-item-1918').click;
  bookingButton.start();
}

var menuitem = document.getElementById("menu-item-1918"); // Find the li menu element in the page

menuitem.onclick = timelyOpen; // Add onclick function to element

function timelyOpen(event) {
  return bookingButton.start();
}
"use strict";